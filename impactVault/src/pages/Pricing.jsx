          ...
          <div className="flex items-end justify-between mb-6 flex-wrap gap-3">
            ...
            <div className="flex items-center bg-stone-900 rounded-2xl p-1 shrink-0">
              <button
                ...
                className={`px-4 py-2 rounded-xl text-xs font-semibold transition-colors ${insightsBilling === "3monthly" ? "bg-white text-stone-900" : "text-stone-400 hover:text-white"
                  }`}
              >
                3 Monthly
              </button>
              <button
                ...
                className={`px-4 py-2 rounded-xl text-xs font-semibold transition-colors ${insightsBilling === "yearly" ? "bg-white text-stone-900" : "text-stone-400 hover:text-white"
                  }`}
              >
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            {visibleInsightsPlans.map((plan) => {
              ...
              return (
                <div
                  key={plan.name}
                  className={`rounded-2xl border p-7 bg-white transition-all ${plan.featured ? "border-amber-400 shadow-lg" : "border-stone-200 hover:shadow-md"
                    }`}
                >
                  {plan.featured && (
                  ...
                  <button
                    ...
                    className={`w-full py-3 rounded-xl font-semibold transition-colors mb-6 ${plan.featured
